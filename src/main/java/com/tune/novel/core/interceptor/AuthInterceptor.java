package com.tune.novel.core.interceptor;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.tune.novel.core.auth.AuthStrategy;
 ...
 * @description: 认证授权 拦截器：为了注入其它的 Spring beans，需要通过 @Component 注解将该拦截器注册到 Spring 上下文
 */
@Component
...
public class AuthInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response,
        ...
        System.out.println("authStrategyName: " + authStrategyName);
        System.out.println("authStrategy: " + authStrategy);
